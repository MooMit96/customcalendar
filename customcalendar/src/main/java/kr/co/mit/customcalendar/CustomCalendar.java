...
public class CustomCalendar extends ViewGroup {
    ...
    private static final TitleFormatter DEFAULT_TITLE_FORMATTER = (TitleFormatter) new DateFormatTitleFormatter();
    ...
    public CustomCalendar(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            titleChanger.setOrientation(
                    a.getInteger(com.prolificinteractive.materialcalendarview.R.styleable.MaterialCalendarView_mcv_titleAnimationOrientation,
                            VERTICAL));
            ...
            setArrowColor(a.getColor(
                    com.prolificinteractive.materialcalendarview.R.styleable.MaterialCalendarView_mcv_arrowColor,
                    Color.BLACK
            ));
            Drawable leftMask = a.getDrawable(
                    com.prolificinteractive.materialcalendarview.R.styleable.MaterialCalendarView_mcv_leftArrowMask
            );
            if (leftMask == null) {
            ...
            Drawable rightMask = a.getDrawable(
                    com.prolificinteractive.materialcalendarview.R.styleable.MaterialCalendarView_mcv_rightArrowMask
            );
            if (rightMask == null) {
...
//            CharSequence[] array = a.getTextArray(R.styleable.MaterialCalendarView_mcv_weekDayLabels);
    ...
    public void setWeekDayFormatter(WeekDayFormatter formatter) {
        adapter.setWeekDayFormatter(formatter == null ? (WeekDayFormatter) WeekDayFormatter.DEFAULT : formatter);
    }
    ...
    public void setWeekDayLabels(CharSequence[] weekDayLabels) {
        setWeekDayFormatter((WeekDayFormatter) new ArrayWeekDayFormatter(weekDayLabels));
    }
     ...
     *
     * @param orientation {@link CustomCalendar#VERTICAL} or {@link CustomCalendar#HORIZONTAL}
     */
     ...
     *
     * @return Title animation orientation {@link CustomCalendar#VERTICAL} or {@link CustomCalendar#HORIZONTAL}
     */
    ...
    protected void dispatchOnDateSelected(final CalendarDay day, final boolean selected) {
        ...
        if (l != null) {
            l.onDateSelected(CustomCalendar.this, day, selected);
        }
    }
    ...
    protected void dispatchOnRangeSelected(final CalendarDay firstDay, final CalendarDay lastDay) {
        ...
        if (listener != null) {
            listener.onRangeSelected(CustomCalendar.this, days);
        }
    }
    ...
    protected void dispatchOnMonthChanged(final CalendarDay day) {
        ...
        if (l != null) {
            l.onMonthChanged(CustomCalendar.this, day);
        }
    }
    ...
    public void onInitializeAccessibilityEvent(@NonNull AccessibilityEvent event) {
        ...
        event.setClassName(CustomCalendar.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(@NonNull AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(CustomCalendar.class.getName());
    }
    ...
    public class StateBuilder {
        ...
        public void commit() {
            CustomCalendar.this.commit(new State(this));
        }
    }
