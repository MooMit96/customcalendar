...
import static kr.co.mit.customcalendar.CustomCalendar.showOtherMonths;
...
public abstract class CalendarPagerView extends ViewGroup implements View.OnClickListener {
    ...
    public CalendarPagerView(@NonNull CustomCalendar view,
    ...
    protected void addDayView(Collection<DayView> dayViews, Calendar calendar) {
        ...
        addView(dayView, new CalendarPagerView.LayoutParams());
    ...
    public void setShowOtherDates(@CustomCalendar.ShowOtherDates int showFlags) {
     ...
     */
    @Override
    public CalendarPagerView.LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new CalendarPagerView.LayoutParams();
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof CalendarPagerView.LayoutParams;
    }
