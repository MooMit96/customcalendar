...
public class DayView extends androidx.appcompat.widget.AppCompatCheckedTextView {
    ...
    protected void setupSelection(@CustomCalendar.ShowOtherDates int showOtherDates, boolean inRange, boolean inMonth) {
