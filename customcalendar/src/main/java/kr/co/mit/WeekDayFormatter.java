...
import kr.co.mit.customcalendar.CalendarUtils;
import kr.co.mit.customcalendar.CalendarWeekDayFormatter;
...
public interface WeekDayFormatter {
     ...
     */
    public static final com.prolificinteractive.materialcalendarview.format.WeekDayFormatter DEFAULT = new CalendarWeekDayFormatter(CalendarUtils.getInstance());
}
